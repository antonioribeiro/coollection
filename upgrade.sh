...
function prepareEnvironment()
{
    ...
    ##
     ...
     #
    rootDir=.
    baseDir=${rootDir}/src/package/Support
    vendor=laravel
    project=framework
...
"
    ...
    stubs=(
        'src/package/Support/IlluminateExtracted/Support/helpers.php'
    )
}
